    ...
    <nav className="w-full bg-white border-b border-gray-200 shadow-sm">
      <div className="mx-auto flex h-16 w-full max-w-7xl items-center justify-between px-6">
        ...
        <div className="hidden md:flex items-center gap-8">
          <Link
            href="#features"
            className="text-gray-700 hover:text-[rgb(2,112,224)] transition-colors font-medium"
          >
            Features
          </Link>
          <Link
          ...
          <Link
            href="/auth"
            className="px-6 py-2.5 bg-[rgb(2,112,224)] text-white rounded-lg hover:bg-[rgb(1,90,180)] transition-colors font-medium shadow-md hover:shadow-lg"
          >
            Login
          </Link>
        </div>
        ...
        <button
          ...
          className="md:hidden p-2 text-gray-700 hover:text-[rgb(2,112,224)] transition-colors"
      ...
      {mobileMenuOpen && (
        <div className="md:hidden bg-white border-t border-gray-200 shadow-lg">
          <div className="px-6 py-4 space-y-4">
            <Link
              href="#features"
              className="block text-gray-700 hover:text-[rgb(2,112,224)] transition-colors font-medium py-2"
            ...
            <Link
              href="/auth"
              className="block px-6 py-2.5 bg-[rgb(2,112,224)] text-white rounded-lg hover:bg-[rgb(1,90,180)] transition-colors font-medium text-center shadow-md"
              onClick={() => setMobileMenuOpen(false)}
            >
              Login
            </Link>
