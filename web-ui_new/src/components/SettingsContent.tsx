  ...
  useEffect(() => {
    const fetchEnvInfo = async () => {
      try {
        ...
        // Mock web environment variables
        const mockWebData: WebEnvInfo = {
          web: {
            nodeEnv: "development",
            databaseUrl: "postgresql://user:password@localhost:5432/db",
            livekitApiEndpoint: "https://livekit.example.com",
            livekitApiKey: "APIxxxxxxxxxxxxxxxxx",
            livekitApiSecret: "SECRETxxxxxxxxxxxxxxxxx",
            livekitSipTrunkId: "trunk_xxxxxxxxx",
          },
          sensitiveKeys: ["databaseUrl", "livekitApiKey", "livekitApiSecret", "livekitSipTrunkId"],
        };

        // Mock agent environment variables
        const mockAgentData: AgentEnvInfo = {
          agentEnv: {
        ...
        setWebEnvInfo(mockWebData);
        setAgentEnvInfo(mockAgentData);
      } catch (err) {
