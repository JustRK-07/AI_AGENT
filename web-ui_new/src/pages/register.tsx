...
import { AiOutlineUser, AiOutlineLock, AiOutlineLoading3Quarters, AiOutlineMail } from "react-icons/ai";
...
export default function Register() {
  ...
  return (
    <>
      <Head>
        <title>Register - Ytel</title>
        <meta name="description" content="Register for Ytel" />
      </Head>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      className="bg-slate-50 dark:bg-slate-900 border-slate-200 dark:border-slate-700 text-slate-900 dark:text-slate-100 focus-visible:ring-blue-500"
                      placeholder="John"
                      required
                    />
                  </div>
